...
export default function EmbeddingModelsPage() {
  return (
    <StubModule
      ...
      rows={[
        { model: "all-MiniLM-L6-v2", dim: 384, use: "Local default", status: <Badge tone="green">active</Badge> },
        { model: "text-embedding-3-small", dim: 1536, use: "OpenAI (optional)", status: <Badge tone="slate">standby</Badge> },
      ]}
